...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("Illegal argument passed in line");//?? throw a TreeException with a useful message
		...
		else
		{
			...
			if (parentNode == null) 
				throw new TreeException("Node not found in the tree");
		}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			...
			throw new TreeException("node not found for the first argument");
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null)
			//??? Throw TreeException with a useful message
			throw new TreeException("node not found for the second argument");
